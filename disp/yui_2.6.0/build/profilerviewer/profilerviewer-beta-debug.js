...
(function() {
	 ...
	 * the output of the YUI Profiler <//developer.yahoo.com/yui/profiler>.
	...
	YAHOO.lang.augmentObject(YAHOO.widget.ProfilerViewer, {
		...
		STRINGS: {
			...
			installFlashMessage: "Unable to load Flash content. The YUI Charts Control requires Flash Player 9.0.45 or higher. You can download the latest version of Flash Player from the <a href='//www.adobe.com/go/getflashplayer'>Adobe Flash Player Download Center</a>."
		},
    ...
    proto.initAttributes = function(attr) {
		 ...
		 * @attribute swfUrl
		 * @type string
		 * @default "//yui.yahooapis.com/2.5.0/build/charts/assets/charts.swf"
		 */
		this.setAttributeConfig('swfUrl', {
			value: attr.swfUrl || "//yui.yahooapis.com/2.5.0/build/charts/assets/charts.swf"
		});
